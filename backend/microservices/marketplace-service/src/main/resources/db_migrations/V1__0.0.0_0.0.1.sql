...
CREATE SEQUENCE licence_config_seq;

ALTER SEQUENCE licence_config_seq
    OWNER TO admin;

CREATE TABLE license_limit_config
(
    id BIGINT DEFAULT NEXTVAL('licence_config_seq'::regclass) PRIMARY KEY,
    ...
    allow_trackout_download BOOLEAN DEFAULT FALSE,      -- czy można pobrać stems/trackout
    ...
    monetization_allowed BOOLEAN DEFAULT FALSE,         -- np. na YouTube z adsense
